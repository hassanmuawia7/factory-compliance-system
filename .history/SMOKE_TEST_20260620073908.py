    ...
    def test_event_factory(self):
        ...
        try:
            ...
            event_data = {
                ...
                "description": "Person outside walkway"
            }
            
            validated = EventFactory.validate_event(event_data)
            assert validated is not None, "Event validation failed"
            assert "severity" in validated, "Severity not assigned"
