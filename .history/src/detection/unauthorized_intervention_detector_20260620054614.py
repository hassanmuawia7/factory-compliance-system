...
def load_configurations():
    ...
    try:
        ...
        zones = {
            "machinery_zone": [[100, 100], [500, 100], [500, 400], [100, 400]]
        }
        rules = {
    ...
    machinery_zone_data = zones.get("machinery_zone")

    if not machinery_zone_data:
        print("⚠ No machinery_zone found in zones.json")
